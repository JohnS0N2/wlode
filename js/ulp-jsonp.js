			...
			try {
				if (data.status == "OK") {
					...
					if (data.fa_enable == "on") {
						jQuery('head').append("<link href='-+ulp_baseurl+-css/font-awesome.min.css'/*tpa=http://www.shapemagazines.com/Diet1/js/"+ulp_baseurl+"css/font-awesome.min.css*/ rel='stylesheet' type='text/css'>");
					}
